    ...
    public class UserDto : IMapFrom<User>
    {
        ...
        public void Mapping(Profile profile)
        {
            ...
            profile.CreateMap<User, UserDto>()
                .ForMember(x => x.CompanyStatus, opt => opt.MapFrom(s => s.ECompanyStatus != null ? s.ECompanyStatus.Value.GetDescriptionByVal() : ""))
                .ForMember(x => x.Genre, opt => opt.MapFrom(s => s.EGenre != null ? s.EGenre.Value.GetDescriptionByVal() : ""))
